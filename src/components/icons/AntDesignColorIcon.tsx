...
export const AntDesignColorIcon = createIcon({
  displayName: "AntDesignColor",
  viewBox:
    "0.6556655367230864 -0.5380000000000003 200.0043344632769 199.88286999097622",
  path: (
    <>
      <defs>
        <linearGradient
      ...
      <g fill="none" fillRule="evenodd">
        <g fillRule="nonzero">
          <path
            d="M91.588 4.177L4.18 91.513a11.981 11.981 0 0 0 0 16.974l87.408 87.336a12.005 12.005 0 0 0 16.989 0l36.648-36.618c4.209-4.205 4.209-11.023 0-15.228-4.208-4.205-11.031-4.205-15.24 0l-27.783 27.76c-1.17 1.169-2.945 1.169-4.114 0l-69.802-69.744c-1.17-1.169-1.17-2.942 0-4.11l69.802-69.745c1.17-1.169 2.944-1.169 4.114 0l27.783 27.76c4.209 4.205 11.032 4.205 15.24 0s4.209-11.022 0-15.227L108.581 4.056c-4.719-4.594-12.312-4.557-16.993.12z"
            fill="url(#ant-design-a)"
          />
          <path
            d="M91.588 4.177L4.18 91.513a11.981 11.981 0 0 0 0 16.974l87.408 87.336a12.005 12.005 0 0 0 16.989 0l36.648-36.618c4.209-4.205 4.209-11.023 0-15.228-4.208-4.205-11.031-4.205-15.24 0l-27.783 27.76c-1.17 1.169-2.945 1.169-4.114 0l-69.802-69.744c-1.17-1.169-1.17-2.942 0-4.11l69.802-69.745c2.912-2.51 7.664-7.596 14.642-8.786 5.186-.883 10.855 1.062 17.009 5.837L108.58 4.056c-4.719-4.594-12.312-4.557-16.993.12z"
            fill="url(#ant-design-b)"
          />
          <path
            ...
            fill="url(#ant-design-c)"
          />
        </g>
        <ellipse
          cx="100.519"
          cy="100.437"
          fill="url(#ant-design-d)"
          rx="23.6"
          ry="23.581"
        />
      </g>
