...
export const ChakraColorIcon: React.FC<IconProps> = (props) => {
  const id = useId();
  const [paint0_id, paint1_id] = [`paint0_linear_${id}`, `paint1_linear_${id}`];
  return (
    <Icon {...props}>
      <svg viewBox="5.25 5.25 29.3333333333333 25.5">
        <defs>
          <linearGradient
            id={paint0_id}
            x1="33.9534"
