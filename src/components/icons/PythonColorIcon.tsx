...
export const PythonColorIcon: React.FC<IconProps> = (props) => {
  const id = useId();
  const [
    linearGradient2795,
    linearGradient4671,
    ...
    `linearGradient2795-${id}`,
    `linearGradient4671-${id}`,
    `linearGradient4689-${id}`,
    `linearGradient1475-${id}`,
    `linearGradient1478-${id}`,
  ];
  return (
    <Icon {...props}>
      <svg viewBox="1.5 -1.5 108.5 115.5">
        <defs>
          <linearGradient id={linearGradient2795}>
            <stop stopColor="#b8b8b8" stopOpacity="0.49803922" offset="0" />
            <stop stopColor="#7f7f7f" stopOpacity="0" offset="1" />
          </linearGradient>
          <linearGradient id={linearGradient4671}>
            <stop stopColor="#ffd43b" stopOpacity="1" offset="0" />
            <stop stopColor="#ffe873" stopOpacity="1" offset="1" />
          </linearGradient>
          <linearGradient id={linearGradient4689}>
            <stop stopColor="#5a9fd4" stopOpacity="1" offset="0" />
            <stop stopColor="#306998" stopOpacity="1" offset="1" />
          </linearGradient>
          <linearGradient
